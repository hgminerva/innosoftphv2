...
namespace TaskManagementSystemV2.Controllers
{
    public class RepTaskDetailController : Controller
    {
        ...
        public ActionResult TaskDetailController(Int32 taskId)
        {
            ...
            headerCompanyTitle.AddCell(new PdfPCell(new Phrase("Cebu Innosoft Solutions Services Inc.", fontArial18Bold)) { HorizontalAlignment = 0, Border = 0, PaddingBottom = 3f });
